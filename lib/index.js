...
exports.default = withFormValidations;
...
function withFormValidations(WrappedComponent, inputs, redux, validations) {
    ...
    function _class2() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {
        inputs: inputs.map(function (i) {
          i.validations = new _validator2.default(i.rules, redux, validations);
          return i;
        })
      }, _this._addInputs = function (inputs) {
        if (!(0, _lodash.isArray)(inputs)) inputs = [inputs];

        _this.setState({
          inputs: _this.state.inputs.concat(inputs.map(function (i) {
            i.validations = new _validator2.default(i.rules, redux, validations, i.value);
            return i;
          }))
        });
      }, _this._field = function (name) {
        return (0, _lodash.find)(_this.state.inputs, function (i) {
          return i.label === name;
        });
        ...
        if (inputs && !(0, _lodash.isArray)(inputs)) {
          inputs = [inputs];
        }
